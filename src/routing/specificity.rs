...
fn default_keywords(category: SpecificityCategory) -> &'static [(&'static str, u32)] {
    match category {
        SpecificityCategory::Coding => &[
            ("code", 1), ("function", 1), ("bug", 1), ("compile", 2),
            ("debug", 2), ("refactor", 2), ("syntax", 1), ("import", 1),
            ("class", 1), ("method", 1), ("variable", 1), ("library", 1),
            ("api", 1), ("endpoint", 1), ("compiler", 2), ("runtime", 1),
            ("thread", 1), ("async", 1), ("promise", 1), ("kernel", 1),
            ("typescript", 2), ("python", 1), ("javascript", 1), ("rust", 2),
            ("golang", 2), ("java", 1), ("kotlin", 1), ("swift", 1),
            ("html", 1), ("css", 1), ("react", 1), ("vue", 1), ("angular", 1),
            ("git", 1), ("commit", 1), ("merge", 1), ("rebase", 1),
            ("stack trace", 2), ("stacktrace", 2), ("exception", 1),
            ("stack overflow", 2), ("lint", 1), ("eslint", 2), ("prettier", 2),
        ],
        SpecificityCategory::WebBrowsing => &[
            ("http", 1), ("https", 1), ("url", 1), ("website", 1),
            ("webpage", 1), ("browse", 2), ("navigate", 1), ("click", 1),
            ("crawl", 2), ("scrape", 2), ("fetch", 1), ("download", 1),
            ("bookmark", 2), ("browser", 2), ("chrome", 1), ("firefox", 1),
            ("safari", 1), ("page", 1), ("link", 1), ("anchor", 1),
            ("form", 1), ("input field", 1), ("cookie", 1), ("session", 1),
        ],
        SpecificityCategory::DataAnalysis => &[
            ("dataset", 2), ("dataframe", 2), ("sql", 1), ("query", 1),
            ("select", 1), ("where", 1), ("join", 1), ("group by", 2),
            ("aggregate", 2), ("sum", 1), ("average", 1), ("mean", 1),
            ("median", 1), ("histogram", 2), ("scatter", 2),
            ("regression", 2), ("correlation", 2), ("p-value", 2),
            ("statistics", 1), ("pandas", 2), ("numpy", 2), ("matplotlib", 2),
            ("csv", 1), ("excel", 1), ("table", 1), ("pivot", 1),
            ("chart", 1), ("graph", 1), ("plot", 1), ("visualize", 2),
            ("dashboard", 1), ("kpi", 2), ("metric", 1), ("benchmark", 1),
        ],
        SpecificityCategory::ImageGeneration => &[
            ("image", 1), ("picture", 1), ("photo", 1), ("illustration", 2),
            ("draw", 2), ("paint", 2), ("render", 1), ("sketch", 2),
            ("midjourney", 3), ("dall-e", 3), ("stable diffusion", 3),
            ("sdxl", 3), ("firefly", 3), ("leonardo", 3), ("imagen", 3),
            ("flux", 2), ("comfyui", 3), ("automatic1111", 3), ("a1111", 2),
            ("prompt", 1), ("negative prompt", 3), ("seed", 1), ("guidance", 1),
            ("denoise", 2), ("upscale", 2), ("inpaint", 2), ("outpaint", 2),
            ("diffusion", 2), ("checkpoint", 1), ("lora", 2),
        ],
        SpecificityCategory::VideoGeneration => &[
            ("video", 1), ("clip", 1), ("movie", 1), ("animation", 2),
            ("animate", 2), ("sora", 3), ("runway", 3), ("kling", 3),
            ("pika", 3), ("veo", 3), ("luma", 3), ("hailuo", 3),
            ("frame", 1), ("fps", 1), ("scene", 1), ("shot", 1),
            ("storyboard", 2), ("film", 1), ("render", 1), ("motion", 2),
            ("temporal", 1), ("keyframe", 2), ("interpolation", 2),
            ("diffusion", 1), ("video diffusion", 3),
        ],
        SpecificityCategory::SocialMedia => &[
            ("tweet", 2), ("post", 1), ("thread", 1), ("retweet", 2),
            ("like", 1), ("share", 1), ("follower", 1), ("engagement", 2),
            ("hashtag", 2), ("mention", 1), ("dm", 2), ("instagram", 2),
            ("facebook", 2), ("twitter", 2), ("x.com", 2), ("linkedin", 2),
            ("tiktok", 2), ("youtube", 1), ("reddit", 2), ("mastodon", 2),
            ("bluesky", 2), ("hootsuite", 3), ("buffer", 2),
            ("impressions", 2), ("reach", 1), ("virality", 2),
            ("influencer", 2), ("trending", 2),
        ],
        SpecificityCategory::EmailManagement => &[
            ("email", 1), ("inbox", 2), ("outbox", 2), ("draft", 1),
            ("reply", 1), ("forward", 2), ("cc", 1), ("bcc", 1),
            ("subject", 1), ("attachment", 2), ("signature", 1),
            ("gmail", 3), ("outlook", 3), ("superhuman", 3),
            ("smtp", 2), ("imap", 2), ("pop3", 2), ("mailgun", 3),
            ("sendgrid", 3), ("newsletter", 2), ("unsubscribe", 2),
            ("spam", 1), ("phishing", 2), ("mail merge", 3),
        ],
        SpecificityCategory::CalendarManagement => &[
            ("calendar", 2), ("meeting", 1), ("appointment", 2),
            ("schedule", 1), ("reschedule", 2), ("invite", 1),
            ("attendee", 2), ("agenda", 2), ("reminder", 1),
            ("google calendar", 3), ("gcal", 3), ("calendly", 3),
            ("reclaim", 3), ("cal.com", 3), ("ics", 2), ("ical", 2),
            ("timezone", 1), ("recurring", 2), ("slot", 1), ("availability", 2),
            ("booking", 2), ("rsvp", 2), ("event", 1), ("venue", 1),
        ],
        SpecificityCategory::Trading => &[
            ("trade", 2), ("stock", 1), ("equity", 1), ("option", 1),
            ("future", 1), ("bond", 1), ("etf", 2), ("crypto", 2),
            ("bitcoin", 2), ("ethereum", 2), ("btc", 2), ("eth", 2),
            ("buy", 1), ("sell", 2), ("short", 1), ("long", 1),
            ("limit order", 3), ("market order", 3), ("stop loss", 3),
            ("take profit", 3), ("portfolio", 2), ("position", 1),
            ("hedge", 2), ("leverage", 2), ("margin", 1), ("dividend", 2),
            ("earnings", 2), ("p/e", 2), ("rsi", 2), ("macd", 2),
            ("moving average", 3), ("bollinger", 3), ("candlestick", 3),
            ("robinhood", 3), ("coinbase", 3), ("binance", 3),
            ("kalshi", 3), ("polymarket", 3), ("alpaca", 3),
        ],
    }
}
